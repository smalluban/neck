...
Neck.Router = (function(_super) {
  ...
  Router.prototype.route = function(route, settings) {
    var myCallback,
      _this = this;
    myCallback = function() {
      var args, options, query, yieldName, _ref, _ref1;
      ...
      for (yieldName in _ref) {
        ...
        if (!((_ref1 = _this.app._yieldList) != null ? _ref1[yieldName] : void 0)) {
          throw "No '" + yieldName + "' yield defined in App";
        }
        _this.app._yieldList[yieldName].append(options.controller || options, _.extend({}, options.params, query), options.refresh, options.replace);
      }
      if (settings.state) {
...
Neck.Helper.collection = (function(_super) {
  ...
  collection.prototype.attributes = ['collectionItem', 'collectionSort', 'collectionFilter', 'collectionView', 'collectionEmpty'];
...
Neck.Helper.list = (function(_super) {
  ...
  list.prototype.attributes = ['listItem', 'listSort', 'listFilter', 'listView', 'listEmpty'];

...
Neck.Controller = (function(_super) {
  ...
  Controller.prototype._setAccessor = function(key, value) {
    var cacheVal, options, resolve, resolves, scope, _i, _len, _ref,
      _this = this;
    cacheVal = "";
  ...
  Controller.prototype.navigate = function(url, params) {
    return Neck.Router.prototype.navigate(url + (params ? '?' + $.param(params) : ''), {
      trigger: true
    });
  };

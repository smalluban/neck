...
Neck.Controller = (function(_super) {
  ...
  function Controller(opts) {
    ...
    if (opts.template && this.template === void 0) {
  ...
  Controller.prototype._parseNode = function(node) {
    var attribute, buffer, child, controller, el, helper, item, name, sortHelpers, stop, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
    if (node != null ? node.attributes : void 0) {
      ...
      for (_j = 0, _len1 = buffer.length; _j < _len1; _j++) {
        item = buffer[_j];
        helper = new item.controller({
          el: el,
          parent: this,
          mainAttr: item.value
        });
        if (helper.template !== void 0) {
          stop = true;
        }
      }
    }

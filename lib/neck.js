...
REVERSE_PARSING = $('<div ui-test1 ui-test2></div>')[0].attributes[0].name === 'ui-test2';
...
Neck.Controller = (function(_super) {
  ...
  Controller.prototype._parseNode = function(node) {
    var attribute, buffer, child, el, helper, item, name, stop, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;

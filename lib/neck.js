  ...
  Controller.prototype._setupRoutes = function() {
    ...
    if (this.routes) {
      ...
      for (key in _ref) {
        ...
        this.routes[key] = (function(route) {
          return function() {
            var args, options, yieldName, _ref1, _ref2;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            for (yieldName in route) {
              options = route[yieldName];
              if ((_ref1 = _this._yieldList) != null) {
                if ((_ref2 = _ref1[yieldName]) != null) {
                  _ref2.append(options.controller || options, _.extend({}, {
                    query: args
                  }, options.params), options.refresh, options.replace);
                }
              }
            }
            return void 0;
      ...
      return this._router = new Backbone.Router({
        routes: this.routes
      });
    }
  };
...
HrefHelper = (function(_super) {
  ...
  function HrefHelper(opts) {
    ...
    (new Backbone.Router).navigate(this.scope._main, {
      trigger: true
    });
  }

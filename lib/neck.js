...
Neck.Controller = (function(_super) {
  ...
  Controller.prototype._watch = function(key, callback, context) {
    ...
    if (val instanceof Backbone.Model || val instanceof Backbone.Collection) {
      this.listenTo(val, "sync change", function() {
    ...
    Object.defineProperty(this.scope, key, {
      ...
      set: function(newVal) {
        ...
        if (newVal instanceof Backbone.Model || val instanceof Backbone.Collection) {
          _this.listenTo(newVal, "sync change", function() {
            return _this.apply(key);
          });
        }
        val = newVal;
  ...
  Controller.prototype.watch = function() {
    var call, callback, initCall, key, keys, _i, _len,
      _this = this;
    keys = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    initCall = true;
    if (typeof (callback = keys.pop()) === 'boolean') {
      initCall = callback;
      callback = keys.pop();
    }
    call = function() {
